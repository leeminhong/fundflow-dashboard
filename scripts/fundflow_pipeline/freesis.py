        ...
        data["records"].append(
            {
                ...
                "sourcePageUrl": FREESIS_STOCK_LINK_URL,
...
def apply_freesis_db(data: dict, db_path: Path) -> None:
    ...
    if stock_deposit:
        ...
        data["items"].append({
            ...
            "link": FREESIS_STOCK_LINK_URL, "displayOrder": 70, "isActive": True,
        ...
        for date_key, raw_val in sorted_dep:
            ...
            data["records"].append({
                ...
                "showInHeatmap": True,
                "changeValue": change, "balanceValue": balance,
                "link": FREESIS_STOCK_LINK_URL, "displayOrder": 70,
                "isActive": True, "hasSourceMapping": True,
                "source": "FREESIS 증시자금추이",
